  ...
  client.on('authentication', authenticate).on('ready', function() {
    ...
    client.on('session', function(accept, reject) {
      ...
      session.once('shell', function(accept, reject) {
        ...
        stream.on('signal', function() { console.log('stream signalled'); });
        stream.on('end', function() { console.log('stream ended'); });
...
var serverOptions = {
  privateKey: fs.readFileSync('host'),
